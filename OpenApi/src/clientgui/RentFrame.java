...
public class RentFrame extends JFrame {
	...
	private String Area[] = {"강서구", "금정구", "남구", "동구", "동래구", "부산진구", "북구", "사하구", "사상구", "서구", "수영구", "연제구", "영도구", "중구", "해운대구"};
	String Sel[];
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					RentFrame frame = new RentFrame(socket);		
